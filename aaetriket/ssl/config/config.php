...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/chironjibmojib-main'); // Replace this value with your project path
}
...
return [
    ...
    'success_url' => 'ssl/pg_redirection/success.php',
    'failed_url' => 'ssl/pg_redirection/fail.php',
    'cancel_url' => 'ssl/pg_redirection/cancel.php',
    'ipn_url' => 'ssl/pg_redirection/ipn.php',
];
