...
<body>
        ...
        <div class="row mx-0" style="margin-top: 10%;">
            <div class="col-md-8 offset-md-2">
                ...
                if ($row['status'] == 'Pending' || $row['status'] == 'Processing') {
                    ...
                    if ($validated) {
                        ...
                        <img src="http://localhost/chironjibmojib-main/assets/images/tickett.jpeg" alt="">

                        <a class="text-center" href="http://localhost/chironjibmojib-main/">Back to Home</a>
