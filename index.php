    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <h3>সিনোপসিস</h3>
                <p>
                    জাতির পিতা বঙ্গবন্ধু শেখ মুজিবুর রহমান এর “অসমাপ্ত আত্মজীবনী” অবলম্বনে ১৯৪৯ থেকে ১৯৫২ পর্যন্ত গণ মানুষের নেতা শেখ মুজিব হয়ে ওঠার প্রেক্ষাপট এবং মহান ভাষা আন্দোলনে তার ভূমিকা নিয়ে নির্মিত চলচ্চিত্র “চিরঞ্জীব মুজিব”
                </p>
            </div>
        </div>
...
<section class="Dialogues bg-light py-5">
    <div class="container" >
        ...
        <div class="row">
            <div class="col-md-3"><img src="assets/img/slider/text1.gif" alt="Chironjib Mujib Dialogues"></div>
            <div class="col-md-3"><img src="assets/img/slider/text2.gif" alt="Chironjib Mujib Dialogues"></div>
            <div class="col-md-3"><img src="assets/img/slider/text3.gif" alt="Chironjib Mujib Dialogues"></div>
            <div class="col-md-3"><img src="assets/img/slider/text4.gif" alt="Chironjib Mujib Dialogues"></div>
        </div>
    </div>
</section>
